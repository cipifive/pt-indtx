...
export const PodcastInput:FC<InputProps> = (props) => {
    ...
    return (
        <div className="flex justify-end items-center pr-4 h-1/6 w-full">
            <span data-testid="podcast-count" className="flex justify-center items-center bg-blue-titles font-bold p-2 rounded text-white w-12 mr-4">{filteredPodcasts.length}</span>
